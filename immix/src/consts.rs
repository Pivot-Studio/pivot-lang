...
pub const MAX_MEDIUM_OBJECT_SIZE: usize = ((BLOCK_SIZE / LINE_SIZE - 3) / 4 - 1) * LINE_SIZE;

pub const MAX_MEDIUM_OBJECT_SIZE_IN_LINE: usize = MAX_MEDIUM_OBJECT_SIZE / LINE_SIZE;
