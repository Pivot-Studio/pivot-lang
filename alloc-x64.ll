...
call_slowpath:
    %rsp17 = tail call ptr asm alignstack "mov %rsp, $0", "=r"() #0
    %2 = ptrtoint ptr %rsp17 to i64
    %slowpath_result = call ptr addrspace(1) @DioGC__malloc_slowpath(i64 %size, i8 %obj_type, i64 %2, ptr @gc_handle)
